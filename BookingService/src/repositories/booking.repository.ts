...
export async function getIdempotencyKeyWithLocking(tx: Prisma.TransactionClient, key:string) {
...
export async function finalizeIdempotencyKeyWithLocking(tx: Prisma.TransactionClient, key: string){
